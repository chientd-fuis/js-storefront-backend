...
var getProductById = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.show(parseInt(productId))];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
...
var deleteProduct = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, product, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                productId = _req.params.productId;
                return [4 /*yield*/, store.deleteOne(parseInt(productId))];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
...
var productHandler = function (app) {
    app.post('/products/add', token_1.verifyToken, create);
    app.get('/products', getAll);
    app.get('/products/:productId', getProductById);
    app.delete('/products/:productId', token_1.verifyToken, deleteProduct);
    app.put('/products/:productId', token_1.verifyToken, updateProduct);
};
