...
var UserModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT user_id, first_name, last_name FROM users WHERE user_id = $1';
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("[Users] Error get user by ID ".concat(userId));
    ...
    UserModel.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, userAuth, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("[Users] Error creating user with error ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET first_name = $1, last_name = $2, user_password = $3 WHERE user_id = $4 RETURNING *';
                        hash = bcrypt_1.default.hashSync(user.password + PEPPER, parseInt(SALT_ROUNDS));
                        return [4 /*yield*/, conn.query(sql, [
                                user.first_name,
                                user.last_name,
    ...
    UserModel.prototype.authenticate = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, userRes, auth, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        sql = 'SELECT user_password FROM users WHERE user_id=($1)';
